      ...
      <section style={{color: "white"}}>
        ...
        <p style={{ position: "relative", textAlign: "justify", display: "inline-block", marginBottom: "70px", fontSize: 19 }}>
          ...
          <ul style={{marginRight: 15, marginLeft: 15,fontSize: "1.15em",margin: 0,padding: 0, listStyle: "none", textAlign: "left" }}>
            {exibirLink("Estadao","Em encontro com empresários, Guedes reconhece erro na dose da reforma tributária e promete correção.", "08/07/2021 22h28", "https://economia.estadao.com.br/noticias/geral,em-encontro-com-empresarios-guedes-diz-que-reforma-tributaria-nao-aumentara-impostos,70003773157")}
