...
function App() {
  ...
  return (
    <div className="App" style={{ backgroundColor: "#2e333e" }}>
      ...
      <section style={{color: "white"}}>
        ...
        <p style={{ position: "relative", textAlign: "justify", display: "inline-block", marginBottom: "70px", fontSize: 19 }}>
          ...
          <ul style={{marginRight: 15, marginLeft: 15,fontSize: "1.15em",margin: 0,padding: 0, listStyle: "none", textAlign: "left" }}>
            {exibirLink("G1","Câmara discute mudanças nas regras do Imposto de Renda", "01/09/2021 20h00", "https://g1.globo.com/politica/ao-vivo/camara-discute-mudancas-nas-regras-do-imposto-de-renda-assista.ghtml")}
            {exibirLink("UOL","País está próximo de reformas tributária e administrativa, afirma Guedes...", "01/09/2021 15h50", "https://economia.uol.com.br/noticias/estadao-conteudo/2021/09/01/pais-esta-proximo-de-reformas-tributaria-e-administrativa-afirma-guedes.htm")}
      ...
      <footer style={{backgroundColor: "white",  paddingBottom: "100px"}}>
        <br/>
        <br/>
